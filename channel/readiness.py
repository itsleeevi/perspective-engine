...
REQUIRED_FILES = (
    ...
    "channel/engine.py",
    "channel/generate.py",
    "channel/character_locks.json",
    "channel/agent_prompts.py",
    "channel/business_prompts.py",
    "channel/takeover_prompts.py",
    "channel/wealth_prompts.py",
    "channel/wealth_pov_master_v13.txt",
    "channel/life_pov_blocks.py",
    "channel/validate_scene_batch.py",
    "channel/validate_story.py",
    "channel/validate_emotion.py",
    "channel/validate_visual.py",
    "channel/validate_period.py",
