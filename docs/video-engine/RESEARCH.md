...
Research happens **before** narration. Wikipedia is a seed only (`channel/research.py`).

Every important claim keeps `claim_id`, text, source, source_date / fiscal_period, confidence, quote or paraphrase. Scenes keep `source_claim_ids`.

Never invent numbers, quotes, market share, motives, meetings, or founder statements. Inferred motive: “This appears to have…” / “The strategy suggests…”.
...
Sacred: fresh research every video; original narration, not rewritten articles or YouTube transcripts.
